...
class WatchlistData {
  ...
  WatchlistData.fromJson(dynamic json) {
    _page = json['page'];
  ...
  num? _totalPages;
  num? _totalResults;
WatchlistData copyWith({  num? page,
  List<Results>? results,
  num? totalPages,
  num? totalResults,
}) => WatchlistData(  page: page ?? _page,
